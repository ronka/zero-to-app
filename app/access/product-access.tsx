...
const repos = [
  {
    ...
    url: process.env.ACCESS_WEB_REPO_URL ?? "https://github.com/ronka/zero-to-saas-web",
    accent: "var(--lime)",
  ...
  },
  {
    ...
    url: process.env.ACCESS_MOBILE_REPO_URL ?? "https://github.com/ronka/zero-to-saas-mobile",
    accent: "var(--sky)",
